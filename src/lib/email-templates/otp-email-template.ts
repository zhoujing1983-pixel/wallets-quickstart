export const renderOtpEmailHtml = (safeCode: string) => `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
          ...
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:520px;background:#ffffff;border-radius:24px;border:1px solid #e2e8f0;box-shadow:0 24px 60px rgba(15,23,42,0.08);">
            <tr>
              <td style="padding:32px;">
                <p style="font-size:12px;letter-spacing:0.3em;text-transform:uppercase;color:#ffad40;margin:0 0 12px 0;">Finyx Wallet Access</p>
