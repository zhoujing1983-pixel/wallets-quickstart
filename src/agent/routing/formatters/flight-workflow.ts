 ...
 * 调用链关系：上游：src/agent/routing/route-service.ts::formatWorkflowResult()；下游：src/agent/routing/route-service.ts::routeAgentChat()（返回 formatFlightWorkflowResult() 结果）。
